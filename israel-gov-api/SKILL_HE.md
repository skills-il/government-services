...
## מלכודות נפוצות
- ממשקי API של נתונים ממשלתיים (data.gov.il) משנים תדיר כתובות URL ומבני endpoints ללא התראה. סוכנים עלולים לקודד endpoints שעבדו בחודש שעבר אבל עכשיו מחזירים 404.
- ה-API של data.gov.il מחזיר נתונים עם כותרות עמודות בעברית כברירת מחדל. סוכנים עלולים להיכשל בפענוח תגובות שמכילות שמות כותרות לא-ASCII בפלט JSON או CSV.
