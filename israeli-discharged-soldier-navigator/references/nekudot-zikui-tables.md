# Nekudot Zikui for Discharged Soldiers (Section 39a)

Statutory base: **Pkudat Mas Hachnasa, Section 39a** (סעיף 39א לפקודת מס הכנסה) + Chok Klitat Chayalim Meshuchrarim.

NOT Section 11 (which covers basic resident credit points for all Israeli residents). NOT Section 9(27) (which covers Pikadon tax exemption). Three different sections, often confused.

## Eligibility table

| Discharge population | Min. service for 1 point/year | Min. service for 2 points/year | Source |
|---|---|---|---|
| Male IDF / MAGAV / Police / SHABAS | 12 months | 23 months | Kolzchut + Section 39a |
...
- **36 calendar months total**
- Starts the **month after** the month of discharge (NOT the discharge month itself)
- Example: Discharge March 15 → credit clock runs April 1 through March of the third year following
- Cannot be paused or extended (use it or lose it)

## 2026 monetary value

| Element | NIS |
|---|---|
| Value per credit point per month | 242 |
| 2 points monthly value | 484 |
| 1 point over 36 months total | 8,712 |
| 2 points over 36 months total | 17,424 |
...
4. The Tax Authority will issue the missed credit as a cash refund
