...
| [israeli-firearm-license-navigator](./israeli-firearm-license-navigator/) | Private firearm license process: eligibility criteria, conditional approval, range training, purchase, 3-year renewal cycle, late-renewal surcharges, storage rules, loss or theft, appeals. Deadline calculator and bilingual stage checklists. | `calculate_license_dates.py`, `build_stage_checklist.py` | 6 |
