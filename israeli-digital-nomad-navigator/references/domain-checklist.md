# Domain Checklist: israeli-digital-nomad-navigator

Scope: Israeli citizens going digital-nomad abroad while keeping an Israeli foothold (visa, tax residency, social security, healthcare, banking). Category: government-services.

## Must cover (core)

- **Destination visa selection for an Israeli passport** with current-year income thresholds (Thailand DTV, Spain DNV, Portugal D8, Estonia, Croatia, Czech Zivno, Mexico, Costa Rica, Georgia, UAE) and the categorical Indonesia/Bali bar. Thresholds drift annually with minimum wages; verify each year.
- **Israeli tax-residency tests:** 183-day and 30+/425-day presumptions, rebuttable center-of-life test, Form 1348, and the **treaty tie-breaker** for dual residency. ITO residency definition.
...
- ETIAS timing for Israeli passports (Q4 2026, mandatory ~April 2027 after a grace period).
- Schengen 90/180 and EES electronic enforcement for rotation planning.
- Host-country tax-residency triggers (e.g. Thailand 180 days) and how the treaty tie-breaker resolves them.
- Georgia Right-to-Labour-Activity permit (1 Mar 2026) and the possible pure-remote carve-out.
- Banking stack (Wise/Payoneer/Revolut + Israeli FX account) and BOI representative-rate FX for tax.
- Return handoff to israeli-relocation-abroad.

## Out of scope (explicit)

- Full permanent relocation / nituk toshavut execution (israeli-relocation-abroad).
- Aliyah to Israel (israeli-aliyah-navigator).
- Foreign nomads coming to Israel; domestic Israeli nomading.
- Binding tax/legal advice and full VAT-return preparation (refer to a CPA / lawyer).
