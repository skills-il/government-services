...
## Standard track (working age)

| Line | Single | Single parent | Couple |
|---|---|---|---|
| Ben Gurion (prepaid card) | 1,250 | 2,300 | 2,500 |
| Bank top-up | 1,544 | 1,631 | 4,023 |
| Each of payments 1-6 | 3,150 | 5,190 | 5,806 |
| **Total** | **21,694** | **35,071** | **41,359** |

## Pre-pension track

Reaches the statutory retirement age within 5 years of aliyah (or of receiving oleh status).

| Line | Single | Single parent | Couple |
|---|---|---|---|
| Ben Gurion (prepaid card) | 1,250 | 2,300 | 2,500 |
| Bank top-up | 1,583 | 1,690 | 3,904 |
| Each of payments 1-6 | 3,992 | 6,201 | 7,414 |
| **Total** | **26,785** | **41,196** | **50,888** |

## Pensioner track

Already at the statutory retirement age set by law (67 for men; 62 to 65 for women by birth year). Not "65+".

| Line | Single | Single parent | Couple |
|---|---|---|---|
| Ben Gurion (prepaid card) | 1,250 | 2,300 | 2,500 |
| Bank top-up | 2,305 | 1,606 | 3,785 |
| Each of payments 1-6 | 3,204 | 4,030 | 4,663 |
| **Total** | **22,779** | **28,086** | **34,263** |

## Supplements

Children never have a basket of their own; they are supplements added to the family's basket.

| Line | Household of 6+ | Aged 18-21 | Child 4-18 | Child 0-4 |
|---|---|---|---|---|
| Ben Gurion (prepaid card) | -- | 250 | 250 | 250 |
| Bank top-up | -- | 3,106 | 3,051 | 3,095 |
| Each of payments 1-6 | 986 | 1,324 | 870 | 1,581 |
| **Total** | **5,918** | **11,039** | **8,521** | **12,831** |

Two of the ministry's own totals are a few shekels off their component sum (the 18-21 row and the 6+ household row). The published total is the authoritative figure.
