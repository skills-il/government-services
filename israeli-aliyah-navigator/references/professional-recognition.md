# Professional License Recognition for Olim

This reference covers the per-profession process for converting foreign professional credentials to Israeli licenses (hakarat miktzoa). Main SKILL.md Step 11 summarizes the high-level path; consult this file for the per-field procedure.

## Medical professions (Misrad HaBriut)

| Profession | Hebrew | Recognizing Body | Typical Process |
|---|---|---|---|
| Physician | rofe | Ministry of Health | Credential review, Hebrew medical-terminology exam, internship (stazh) at an Israeli hospital |
...
Typical timeline: 1-2 years for physicians; shorter for nurses if Hebrew is already fluent.

## Engineering (MAHAT)

- Apply through MAHAT (Center for Technological Education) or the relevant engineering union (e.g., Mechanical Engineers Union, Civil Engineers Union)
- Submit academic transcripts and professional experience documentation
- Some specializations require an equivalency exam
- **Recent reform:** professional engineering licenses can now be approved from abroad before making aliyah, allowing immediate work upon arrival. Verify with the relevant union before flying.
...
- Process typically takes 2-3 years from arrival to bar admission
- Some bar-exam subjects may be exempted for graduates of common-law jurisdictions; others (Israeli civil procedure, tax) are mandatory
...
- Teaching credentials evaluated for equivalency by the Pedagogic Council
- Hebrew proficiency required (typically Ulpan Bet or higher; some grade levels require advanced)
- May require additional Israeli pedagogical training, especially for those teaching in Hebrew-language schools
- English-language private schools have separate hiring channels with lower Hebrew requirements
...
## Common rejection / delay causes

- Apostille from wrong authority (must be from issuing country's designated Hague authority, not a generic notary)
- Translation by a translator who is not a recognized notary in Israel
