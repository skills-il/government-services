...
- A **widower (male)** is subject to an income test: entitled if his total income is up to 7,848 NIS a month, after deducting 2,093 NIS from income from work (employee or self-employed), pension, or a monthly income first paid at retirement age. Bituach Leumi states this condition for a widower without carving out those with children, so do not tell a widower with children that the test does not reach him; income is measured over the 12 months before the month of his wife's death (including that month), or over the calendar year in which she died. If a widower's income later rises above the ceiling the allowance stops and he is paid the survivor grant instead; if his income falls again, entitlement is re-examined and the grant already paid is deducted from the renewed allowance.
